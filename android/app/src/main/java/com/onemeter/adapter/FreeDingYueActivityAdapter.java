 ...
 * 备注：
 */
public class FreeDingYueActivityAdapter extends BaseExpandableListAdapter {
    private Context context;
    /**
     * 组item信息
     **/
    private List<hotschool> group;
    /**
     * 子item信息
     **/
    ...
    public FreeDingYueActivityAdapter(Context context, List<hotschool> group, List<List<String>> child) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            ViewUtils.inject(viewHolder1, convertView);
        ...
        //设置数据
        viewHolder1.text_my_dingyue_title.setText(group.get(groupPosition).getSchool());
        viewHolder1.text_my_number_jiulanliang.setText(group.get(groupPosition).getSubCount()+"");
        viewHolder1.my_dingyue_number.setText(group.get(groupPosition).getAllScanCount()+"");
        bitmapUtils.display(viewHolder1.img_my_dingyue_title, group.get(groupPosition).getHeadImage());
